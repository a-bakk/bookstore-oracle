...
BEGIN
    ...
    ELSIF option_text = 'records' THEN
        ...
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (4, ''John'', ''Scalzi'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (5, ''John C.'', ''Lennox'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (6, ''John C.'', ''Lennox'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (7, ''Astro'', ''Mijamori'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (8, ''James R.'', ''Hansen'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (9, ''Matt'', ''Allen'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (9, ''Steven'', ''Knight'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (10, ''Sara'', ''Faring'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (11, ''Stephen'', ''King'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (12, ''Stephen'', ''King'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (13, ''Norbert'', ''Kis'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (14, ''Walter'', ''Tevis'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (15, ''Michael J.'', ''Sullivan'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (16, ''Walter'', ''Tevis'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (17, ''Alekszej'', ''Kalugin'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (18, ''Max'', ''Seeck'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (19, ''Ellis'', ''Joy'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (20, ''Dan'', ''Simmons'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (21, ''Dan'', ''Simmons'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (22, ''J. S.'', ''Carol'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (23, ''Frederick'', ''Forsyth'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (24, ''Frederick'', ''Forsyth'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (25, ''Robert'', ''Bryndza'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (26, ''Mark'', ''Edwards'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (27, ''Mark'', ''Edwards'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (28, ''Leigh'', ''Bardugo'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (29, ''Leigh'', ''Bardugo'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (30, ''Sherba'', ''Natalia'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (31, ''Paula'', ''Hawkins'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (32, ''Paula'', ''Hawkins'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (33, ''Jamie'', ''McGurie'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (34, ''T. B.'', ''Byrt'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (35, ''Michel'', ''Bussi'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (36, ''Michel'', ''Bussi'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (37, ''Anne'', ''Frasier'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (38, ''Stephen'', ''King'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (39, ''George R. R.'', ''Martin'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (40, ''Sylvain'', ''Neuvel'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (41, ''Jussi'', ''Adler-Olsen'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (42, ''Jozef'', ''Karika'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (43, ''Stanislaw'', ''Lem'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (44, ''Adrian'', ''Tchaikovsky'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (45, ''Adrian'', ''Tchaikovsky'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (46, ''Manon'', ''Fargetton'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (47, ''Alexandra'', ''Bracken'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (48, ''András'', ''Cserna-Szabó'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (49, ''Nate'', ''Blakeslee'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (50, ''Nate'', ''Blakeslee'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (51, ''Meg Waite'', ''Clayton'')';
        EXECUTE IMMEDIATE 'INSERT INTO AUTHOR VALUES (52, ''Meg Waite'', ''Clayton'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (2, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (3, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (3, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (4, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (4, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (5, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (5, ''társadalomtudomány'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (6, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (6, ''társadalomtudomány'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (7, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (7, ''történelmi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (8, ''életrajz'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (9, ''életrajz'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (10, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (10, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (10, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (11, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (11, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (11, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (12, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (12, ''kimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (12, ''thiller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (13, ''természettudomány'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (13, ''biológia'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (14, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (14, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (15, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (15, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (16, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (16, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (17, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (17, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (18, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (18, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (18, ''thiller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (19, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (19, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (19, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (20, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (20, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (20, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (21, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (21, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (21, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (22, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (22, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (22, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (23, ''történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (23, ''egytemes történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (23, ''hadtörténet'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (24, ''történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (24, ''egytemes történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (24, ''hadtörténet'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (25, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (25, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (25, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (26, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (26, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (26, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (27, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (27, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (27, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (28, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (28, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (29, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (29, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (30, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (30, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (31, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (31, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (31, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (32, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (32, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (32, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (33, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (33, ''ifjúsági irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (33, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (34, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (34, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (35, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (35, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (35, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (36, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (36, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (36, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (37, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (37, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (37, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (38, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (38, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (38, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (39, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (39, ''fantasy'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (40, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (40, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (41, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (41, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (41, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (42, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (42, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (42, ''thriller'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (43, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (43, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (44, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (44, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (45, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (45, ''sci-fi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (46, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (46, ''akció'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (46, ''kaland'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (47, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (47, ''ifjúsági irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (47, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (48, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (48, ''romantikus'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (48, ''kaland'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (49, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (49, ''akció'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (49, ''kaland'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (50, ''szórakoztató irodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (50, ''akció'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (50, ''kaland'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (51, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (51, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (52, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (52, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (53, ''szépirodalom'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (53, ''regény'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (54, ''szépirodalom'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Debreceni Kis-Bookaround'', ''Aulich utca 7'', ''Debrecen'', ''Hajdú-Bihar-Bereg vármegye'', ''4002'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Bookaround Debreceni Nagykönyvesbolt'', ''Kerekerdő utca 11'', ''Debrecen'', ''Hajdú-Bihar-Bereg vármegye'', ''4020'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Dózsa György Bookaround'', ''Dózsa György út 63'', ''Miskolc'', ''Borsod-Abaúj-Zemplén vármegye'', ''3528'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Pécsi Bookaround Könyvesbolt'', ''Kossuth Lajos u. 5'', ''Pécs'', ''Baranya vármegye'', ''7634'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Acél Bookaround'', ''Acél utca 40'', ''Nyíregyháza'', ''Szabolcs-Szatmár-Bereg vármegye'', ''4400'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Kecskeméti Tesco Bookaround Könyvesboltja'', ''Levél utca 18'', ''Kecskemét'', ''Bács-Kiskun vármegye'', ''6044'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Gyimesi Könyvesbolt'', ''Gyimesi utca 6'', ''Székesfehérvár'', ''Fejér vármegye'', ''8017'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Szombathelyi Bookaround'', ''Hét vezér utca 28'', ''Szombathely'', ''Vas vármegye'', ''9700'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Bookaround Érdi Könyvesboltja'', ''Tétényi út 11'', ''Érd'', ''Pest vármegye'', ''2030'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Szolnok Bookaround'', ''Zerge utca 23'', ''Szolnok'', ''Jász-Nagykun-Szolnok vármegye'', ''5000'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Tatabányai Bookaround Könyvesbolt'', ''Márna utca 55'', ''Tatabánya'', ''Komárom-Esztergom vármegye'', ''2800'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Sopron Bookaround'', ''Selmeci utca 31'', ''Sopron'', ''Győr-Moson-Sopron vármegye'', ''9400'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Kaposvári Tesco Bookaround Könyvesboltja'', ''Gróf Apponyi Albert utca 1-3'', ''Kaposvár'', ''Somogy vármegye'', ''7451'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Békéscsaba Bookaround Könyvesbolt'', ''Fiumei utca 14'', ''Békéscsaba'', ''	Békés vármegye'', ''5623'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Veszprémi Bookaround Könyvesbolt'', ''József Attila utca 7'', ''Veszprém'', ''Veszprém vármegye'', ''8200'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Bookaround Zalaegerszeg'', ''Csavargyár u. 47'', ''Zalaegerszeg'', ''Zala vármegye'', ''8900'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Egri Bookaround Könyvesbolt'', ''Hősök utca 7'', ''Eger'', ''Heves vármegye'', ''3304'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Bookaround Hódmezővásárhelyi Kisüzlet'', ''Őszirózsa utca 1'', ''Hódmezővásárhely'', ''Csongrád-Csanád vármegye'', ''Lepke utca'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Lepke Bookaround'', ''Lepke utca 30'', ''Szeged'', ''Csongrád-Csanád vármegye'', ''6753'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Ceglédi Bookaround Könyvesbolt'', ''Borona utca 15'', ''Cegléd'', ''Pest vármegye'', ''2700'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Budapesti Istenhegyi Tesco Bookaround'', ''Istenhegyi út 29'', ''Budapest'', ''Budapest'', ''1112'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Vác Bookaround Könyvesbolt'', ''Csillag utca 32'', ''Vác'', ''Pest vármegye'', ''2600'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Ügető Bookaround'', ''Ügető utca 71'', ''Budapest'', ''Budapest'', ''1124'', ''Magyarország'')';
        EXECUTE IMMEDIATE 'INSERT INTO STORE (NAME, STREET, CITY, STATE_OR_REGION, POSTCODE, COUNTRY) VALUES (''Bookaround Siófok'', ''Dózsa György utca 8'', ''Siófok'', ''Somogy vármegye'', ''8600'', ''Magyarország'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (4, 1, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (14, 1, 24)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (28, 1, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (29, 1, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (31, 1, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (32, 1, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (38, 1, 35)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (40, 1, 40)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (41, 1, 35)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (43, 1, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (52, 1, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (53, 1, 10)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (55, 1, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (5, 2, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (7, 2, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (11, 2, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (20, 2, 45)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (22, 2, 60)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (23, 2, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (24, 2, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (40, 2, 32)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (41, 2, 40)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (9, 3, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (10, 3, 28)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (15, 3, 31)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (16, 3, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (18, 3, 34)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (27, 3, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (28, 3, 48)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (29, 4, 53)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (30, 4, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (49, 4, 43)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (50, 4, 47)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (51, 4, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (52, 4, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (54, 4, 24)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (6, 5, 26)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (16, 5, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (17, 5, 17)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (22, 5, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (24, 5, 30)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (25, 5, 34)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (33, 5, 23)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (37, 5, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (47, 5, 47)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (48, 5, 35)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (8, 6, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (14, 6, 28)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (18, 6, 31)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (20, 6, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (22, 6, 61)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (23, 6, 46)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (32, 6, 28)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (36, 6, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (37, 6, 20)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (49, 6, 19)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (50, 6, 10)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (53, 6, 16)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (10, 7, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (20, 7, 24)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (30, 7, 64)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (40, 7, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (20, 8, 80)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (25, 8, 11)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (30, 8, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (40, 8, 42)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (7, 9, 13)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (14, 9, 43)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (20, 9, 35)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (30, 10, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (47, 10, 36)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (48, 10, 26)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (55, 10, 10)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (1, 11, 15)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (11, 11, 70)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (23, 15, 45)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (26, 15, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (28, 15, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (40, 15, 50)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (42, 15, 56)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (10, 16, 45)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (13, 16, 54)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (26, 16, 37)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (5, 17, 65)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (41, 17, 25)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (47, 17, 53)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (30, 24, 27)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (38, 24, 35)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (39, 24, 45)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (7, 27, 45)';
        EXECUTE IMMEDIATE 'INSERT INTO STOCK VALUES (19, 27, 45)';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (4, ''08:00 AM'', ''06:00 PM'', 1)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (5, ''08:00 AM'', ''06:00 PM'', 1)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (1, ''10:00 AM'', ''10:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (2, ''10:00 AM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (3, ''10:00 AM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (4, ''10:00 AM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (5, ''10:00 AM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (6, ''12:00 PM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (7, ''12:00 PM'', ''04:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (1, ''08:00 AM'', ''06:00 PM'', 3)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (2, ''08:00 AM'', ''06:00 PM'', 3)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (4, ''08:00 AM'', ''06:00 PM'', 3)';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (7, ''12:00 PM'', ''04:00 PM'', 3)';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO NOTIFICATION (MESSAGE, CUSTOMER_ID) VALUES (''Kívánságlistán lévő könyvek újra kaphatóak!'', 1)';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (1, 2)';
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (1, 3)';
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (1, 4)';
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (2, 1)';
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (3, 1)';
        EXECUTE IMMEDIATE 'INSERT INTO CONTAINS VALUES (3, 2)';
