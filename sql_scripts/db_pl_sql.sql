...
BEGIN
    ...
    ELSIF option_text = 'records' THEN
        ...
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (7, ''történelem'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (12, ''krimi'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (12, ''thriller'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (18, ''thriller'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (23, ''egyetemes történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (23, ''hadtörténet'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (24, ''történelem'')';
        EXECUTE IMMEDIATE 'INSERT INTO GENRE VALUES (24, ''egyetemes történelem'')';
        ...
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (6, ''12:00 AM'', ''08:00 PM'', 2)';
        EXECUTE IMMEDIATE 'INSERT INTO BUSINESS_HOURS (DAY_OF_WEEK, OPENING_TIME, CLOSING_TIME, STORE_ID) VALUES (7, ''12:00 AM'', ''04:00 PM'', 2)';
